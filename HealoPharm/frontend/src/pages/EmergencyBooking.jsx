                ...
                <tr key={doctor.demail}>
                  ...
                  <td style={{ padding: "12px 15px", borderBottom: "1px solid #ddd" }}>
                    <button
                      ...
                      disabled={doctor.dcapacity === 0 || doctor.availableSlots === "Unavailable right now!"}
                      style={{
                        backgroundColor: doctor.dcapacity === 0 || doctor.availableSlots === "Unavailable right now!"
                          ? "gray"
                          : "green",
                        color: "white",
                        padding: "8px 16px",
                        border: "none",
                        borderRadius: "4px",
                        cursor: doctor.dcapacity === 0 || doctor.availableSlots === "Unavailable right now!"
                          ? "not-allowed"
                          : "pointer",
                      }}
                    >
